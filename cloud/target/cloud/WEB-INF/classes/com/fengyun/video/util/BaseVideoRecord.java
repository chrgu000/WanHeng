...
public class BaseVideoRecord {
	// 账号AK信息请填写(必选)
	protected static String access_key_id = "LTAIEF8Ez9nRobW5";
	// 账号AK信息请填写(必选)
	protected static String access_key_secret = "A9zmv15Z3VdHxefqP41aXxgtMKDuX8";
	// STS临时授权方式访问时该参数为必选，使用主账号AK和RAM子账号AK不需要填写
	protected static String security_token = "";
	// 以下参数不需要修改
	protected final static String VOD_DOMAIN = "http://live.aliyuncs.com/";
	...
	private final static Logger LOG = Logger.getLogger(BaseVideoRecord.class
			.getName());
	/**
	 * 生成OpenAPI地址
	 * 
	...
	protected static String generateOpenAPIURL(
		...
		return generateURL(VOD_DOMAIN, HTTP_METHOD, publicParams,
				protectedParams);
	}
