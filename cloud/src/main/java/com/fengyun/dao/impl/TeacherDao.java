...
public class TeacherDao extends AbstractDao implements ITeacherDao {
	...
	public Page page(Page page, Teacher teacher) {
		...
		IPageQuery pageQuery = pageQueryFactory.getPageQuery(page,"com.fengyun.dao.ITeacherDao.selectTeacherPage", "com.fengyun.dao.ITeacherDao.selectTeacherCount");
		return pageQuery.select(teacher);
	}
