...
public class UpdateVideoRecordCallBack extends BaseVideoRecord{
    ...
    private static Map<String, String> generatePrivateParamters() {
        ...
        privateParams.put("Action", "UpdateLiveRecordNotifyConfig");
        privateParams.put("DomainName", "zhibo.woheyun.com");
//        privateParams.put("NotifyUrl", "https://woheyun.com/cloud/com/courseAction/recordCallback.action");
