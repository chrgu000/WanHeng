...
import com.yingtong.serviceImpl.AdminServiceImpl;
import com.yingtong.serviceImpl.PowerServiceImpl;
...
public class AdminController {
	...
	public String loginAction(Admin admin, HttpServletRequest request,
		...
		List<TitleAddr> titleAddrs=dao.findAllTitleAddr();//获取所有的市区
		session.setAttribute("titleAddrs", titleAddrs);//session保存所有的市区信息
