...
function advanceMoney(value) {
	...
	if(value>'${user.money}'){
		newaddress.ealert("您的余额不足");
		bool=false;
		return;
	}
	if(bool){
	location.href = "../order/advanceMoney.do?money=" + value;
	}
}
</script>
</head>
	...
	<div id="all">
		...
		<div class="money-tc" id="m"
			...
			<dl>
				<dt>充值</dt>
				<dd>
					<input type="text" placeholder="请输入充值金额" value="${money}"
						onchange="addMoney(this.value)"> <a href="#"
						id="weixinpay">确认</a>
				</dd>
			</dl>
		</div>
		<div class="money-tc" id="n">
			<a href="javascript:;" class="zhe">&nbsp;</a>
			<dl>
				<dt>提现</dt>
				<dd>
					<input type="text" onchange="advanceMoney(this.value)"
						placeholder="请输入提现金额"> <a href="#">确认</a>
				</dd>
			</dl>
		</div>
	</div>
