		...
		<div
			...
			<div id="i_do_wrap">
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text"  name="name" id="name" onblur="checkName()" onfocus="removeError('name')"
						class="block input left tline" placeholder="品牌名称"
						value="${brand.name}" />&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="nameError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					<p class="i_do_tle r_txt abs font14">排列序号</p>
					<input type="text" name="num" id="num" onblur="checkNum()" onfocus="removeError('num')"
						class="block input left tline" placeholder="排列序号"
						value="${brand.num}" />&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="numError"></label>
				</div>
