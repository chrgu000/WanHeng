...
<body>
	<form
		action="${pageContext.request.contextPath}/motorcycle/updateMotorcycle.do"
		...
		<div
			...
			<input type="hidden" name="id" value="${motorcycle.id }">
					...
					<input type="text" id="name" name="name" class="block input left tline"  onblur="checkName()" onfocus="removeError('name')"
						value="${motorcycle.name}"/>&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="nameError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					value="${motorcycle.num }" />&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="numError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
