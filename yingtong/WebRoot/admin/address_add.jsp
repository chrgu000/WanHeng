...
<body>
	<form
		action="${pageContext.request.contextPath}/address/addAddress.do"
			...
			<div id="i_do_wrap">
				...
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="addname" name="addName" onblur="checkAddName()" onfocus="removeError('addName')"
						class="block input left tline" placeholder="站点名称" />&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="addNameError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					<p class="i_do_tle r_txt abs font14">地址</p>
					<input type="text" id="address" name="address"
						class="block input left tline" placeholder="地址" onblur="checkAddress()" onfocus="removeError('address')"/>&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="addressError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					<p class="i_do_tle r_txt abs font14">手机</p>
					<input type="text" id="tel" name="tel"
						class="block input left tline" placeholder="手机" onblur="checkTel()" onfocus="removeError('tel')"/>&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="telError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="businessHour" name="businessHour" onblur="checkBusinessHour()" onfocus="removeError('businessHour')"
 						class="block input left tline" placeholder="营业时间" />&nbsp;&nbsp;&nbsp;<label class="labelError"
				...
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="num" name="num" onblur="checkNum()" onfocus="removeError('num')"
						class="block input left tline" placeholder="序列号" />&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="numError"></label>
				</div>
