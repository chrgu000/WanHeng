			...
			<div id="">
				<div class="pro_sou">
					...
					身份证号:<input type="text" name="idcard"
						value="${sessionScope.userPage.idcard }" class="input "
				...
				<div id="list_wrap" class="rel " style="width:98%;margin-top: 17px">
					<table style="width:100%">
						<tr
							...
							<td style="width:30%;" class="xiahuaxian">身份证号</td>
								<td style="width:15%;" class="xiahuaxian">注册时间</td>
						...
						<c:forEach items="${users}" var="u">
							<tr
								...
								<td class="xiahuaxian">${u.idcard }</td>
									<td  class="xiahuaxian"><fmt:formatDate value="${u.regist_time }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
								<td class="xiahuaxian"><a
									href="${pageContext.request.contextPath}/user/deleteUserById.do?id=${u.id}"
									onclick="return confirm('删除之后会连带删除用户的订单信息，确认删除吗？');">删除</a>
								</td>
							</tr>
						</c:forEach>
