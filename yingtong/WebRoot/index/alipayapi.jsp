...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.yingtong.config.*"%>
<%@ page import="com.yingtong.util.*"%>
...
<%
	...
	String out_trade_no = request.getParameter("order_num");
	//手机号，必填
	String subject = request.getParameter("tel");

	//付款金额，必填
	//String total_fee = request.getParameter("total_price");
