...
public class Util {
    ...
    //前置机地址
    public static final String FRONT_END_COMPUTER = PropertiesUtil.load("bank.properties", "front_end_computer");
    
    public static final String HOST = "http://121.15.180.66:801/";
    public static final String CE_HOST = "http://121.15.180.72/";//公钥测试端口

    // 支付+签约
    public static final String URL_PREPAYEUSERP_D = HOST + "NetPayment/BaseHttp.dll?MB_EUserPay";
