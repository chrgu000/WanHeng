package com.cgwas.imgInfo.dao.impl;
...
@Service
public class ImgInfoDao extends AbstractDao implements IImgInfoDao {
	private PageQueryFactory<PageQuery> pageQueryFactory;

	public Page page(Page page, ImgInfo imgInfo) {

		IPageQuery pageQuery = pageQueryFactory.getPageQuery(page,
				"selectImgInfoPage", "selectImgInfoCount");
		return pageQuery.select(imgInfo);
	}
