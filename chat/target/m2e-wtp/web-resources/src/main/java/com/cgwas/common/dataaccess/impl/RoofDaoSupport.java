...
import com.cgwas.common.dataaccess.api.DaoException;
import com.cgwas.common.dataaccess.api.IdGenerator;
import com.cgwas.common.dataaccess.api.SqlDescription;
import com.cgwas.common.utils.RoofMapUtils;
...
public class RoofDaoSupport extends RoofAbstractDao {
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public void deleteAll(Map<String,Object> map,Object entity) {
		Class<?> entityClass = entity.getClass();
		sqlSessionTemplate.delete(getStatementName("deleteAll" + entityClass.getSimpleName(), entityClass), map);
	}
