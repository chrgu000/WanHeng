...
<body>
	<form
		action="${pageContext.request.contextPath}/picture/addPicture.do"
			...
			<c:if test="${picturePage.type=='1' }">
				...
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="i_no_sku_stock" name="url"
						class="block input left tline" placeholder="图片的应用路径" />
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
				...
				<div class="i_do_div rel" id="i_no_sku_stock_wrap" style="display:none">
					<p class="i_do_tle r_txt abs font14">图片的应用类型</p>
					<input type="text" id="i_no_sku_stock" name="type"
						class="block input left tline" placeholder="图片的应用类型"  value="${picturePage.type}"/>
				</div>
