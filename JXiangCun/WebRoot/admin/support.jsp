			...
			<div id="list_wrap" class="rel " style="width:98%;margin-top: 17px">
				<table style="width:100%">
					<tr
						...
						<td style="width:10%;" class="xiahuaxian">头像</td>
						<td style="width:20%;" class="xiahuaxian">昵称</td>
						<td style="width:20%;" class="xiahuaxian">支持时间</td>
						<td style="width:10%;" class="xiahuaxian">支持产品</td>
						<td style="width:10%;" class="xiahuaxian">操作</td>
					</tr>
					<c:forEach items="${supports}" var="s">
						<tr
							style="text-align:center; line-height:30px; border-bottom:1px solid #CCC; font-size:13px;">
							<td class="xiahuaxian"><img
									src="../${s.path }" style="width:110px; height:110px" /></td>
							<td class="xiahuaxian">${s.nickname}</td>
							<td class="xiahuaxian"><fmt:formatDate value="${s.support_time }" pattern="yyyy-MM-dd HH:mm:ss"/></td>
							<td class="xiahuaxian">${s.product.title}</td>
							<td class="xiahuaxian"> 
  				...
  				<a class="inline_b btns_2" href="${pageContext.request.contextPath}/support/supportList.do?currentPage=1">首页</a>&nbsp;&nbsp;
  				<a class="inline_b btns_2" href="${pageContext.request.contextPath}/support/supportList.do?currentPage=${page.currentPage-1==0?1:page.currentPage-1}">上一页</a>&nbsp;&nbsp;
  				<c:forEach begin="1" end="${page.totalPage}" var="num">
  					<a class="inline_b btns_2" style="width:30px;"href="${pageContext.request.contextPath}/support/supportList.do?currentPage=${num}">${num }</a>
  				</c:forEach>
  				&nbsp;&nbsp;
  				<a class="inline_b btns_2" href="${pageContext.request.contextPath}/support/supportList.do?currentPage=${page.currentPage+1>page.totalPage?page.totalPage:page.currentPage+1}">下一页</a>&nbsp;&nbsp;
  				<a class="inline_b btns_2" href="${pageContext.request.contextPath}/support/supportList.do?currentPage=${page.totalPage}">尾页</a>
  				...
  				<script type="text/javascript">
  					function jump(){
						...
						window.location.href="${pageContext.request.contextPath}/support/supportList.do?currentPage="+num;
  					}
  				</script>
						</td>
					</tr>
