...
<body>
	<form action="../search/updateSearch.do" name="regForm"
			...
			<div id="i_do_wrap">
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="title" name="title" onblur="checkTitle()"
						...
						placeholder="搜索标题" value="${search.title }"/>&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="titleError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="chr" name="chr" onblur="checkChr()"
						...
						placeholder="内容" value="${search.chr }" />&nbsp;&nbsp;&nbsp;<label class="labelError"
						id="chrError"></label>
				</div>
				<div class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="url" name="url" onblur="checkUrl()"
						...
						placeholder="链接" value="${search.url }"  />&nbsp;&nbsp;&nbsp;<label
				...
				<div  class="i_do_div rel" id="i_no_sku_stock_wrap">
					...
					<input type="text" id="num" name="num" onblur="checkNum()"
						...
						placeholder="序号" value="${search.num }" />&nbsp;&nbsp;&nbsp;<label
